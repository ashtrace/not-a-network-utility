...
//\
https://ntdoc.m417z.com/pps_post_process_init_routine
...
typedef struct _OBJECT_ATTRIBUTES {
    ULONG           Length;              // must always be set
    HANDLE          RootDirectory;       // handle to root directory object
    PUNICODE_STRING ObjectName;          // name of the object
    ULONG           Attributes;          // OBJ_INHERIT, OBJ_CASE_INSENSITIVE etc
    PVOID           SecurityDescriptor;  // SECURITY_DESCRIPTOR or NULL
    PVOID           SecurityQualityOfService; // SECURITY_QUALITY_OF_SERVICE or NULL
} OBJECT_ATTRIBUTES;